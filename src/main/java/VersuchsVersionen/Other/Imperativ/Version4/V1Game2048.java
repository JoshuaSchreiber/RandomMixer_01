package VersuchsVersionen.Other.Imperativ.Version4;
...
public class V1Game2048 extends JFrame implements AWTEventListener {
    ...
    public void initComponents() {
        ...
        colorChange.addActionListener(e -> {
            if(e.getSource() == this.colorChange){
                ...
                String One;
                for(int i = 16; i > 0; i--){
                    One = labelHashMap.get(String.valueOf(i)).getText();
                    iOne = Integer.parseInt(One);
                    forBackGround(i, iOne);
                }
            }
    ...
    public void actualise(int hLength, int fieldNumber){
        int fieldWorth = Integer.parseInt(labelHashMap.get((String.valueOf(hLength))).getText());
        for(int i = hLength; i >0; i--) {
            labelHashMap.get(String.valueOf(fieldNumber)).setText(String.valueOf(fieldWorth));
            forBackGround(fieldNumber, fieldWorth);
        }
    }
}

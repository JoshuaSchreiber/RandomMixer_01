package VersuchsVersionen.Other.Imperativ.Version7;
...
public class V1Game2048 extends JFrame implements AWTEventListener {
    ...
    public String theSameAndOneIsZero(String one, String two, String three, String four) throws InterruptedException {
        ...
        if(x1.equals("NoChange") && x2.equals("NoChange") && x3.equals("NoCahnge")){ ergebnis = "NoChange";}
        return ergebnis;
    }
    public String theSame(String one, String two, String three, String four) throws InterruptedException {
        ...
        int[] arr2 = getFourMethode(one, arr[0], two, arr[1], three, arr[2], four, arr[3]);
        if(arr != arr2){
        ...
        int[] arr3 = getFourMethode(one, arr[0], two, arr[1], three, arr[2], four, arr[3]);
        if(arr2 != arr3){
            TimeUnit.MILLISECONDS.sleep(100);
        }
        if (arr[1] == arr[0]) {
        ...
        int[] arr4 = getFourMethode(one, arr[0], two, arr[1], three, arr[2], four, arr[3]);
        if(arr3 != arr4){
            TimeUnit.MILLISECONDS.sleep(100);
        }
    ...
    public String oneIsZero(String one, String two, String three, String four) throws InterruptedException {
        ...
        for(int i = 4; i > 0; i--) {
            ...
            int[] arr2 = setFourMethode(one, two, three, four);
            for(int x = 0; x < 4; x++){
            ...
            if(arr != arr2){
                TimeUnit.MILLISECONDS.sleep(100);
                int[] gFM = getFourMethode(one, arr[0], two, arr[1], three, arr[2], four, arr[3]);
            }
            if (arr[2] == 0) {
                arr[2] = arr[1];
                arr[1] = 0;
    ...
    public int[] getFourMethode(String one, int iOne, String two, int iTwo, String three, int iThree, String four, int iFour){
        int[] arr = new int[4];
        arr[0] = iOne;
        arr[1] = iTwo;
        arr[2] = iThree;
